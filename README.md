...
Provide step by step instructions on how to run your application. Are there any prerequisite software packages required?
...
* The repository contains, at minimum, two commits per week (Note: There should be many commits per day while coding).
